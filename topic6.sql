...
INSERT INTO questions (quesID, Question, AnswerA, AnswerB, AnswerC, AnswerD, CorrectAnswer) VALUES
('Q101', 'Identify the correctly punctuated sentence: He said, "I will be there soon".', 'A. He said, "I will be there soon"', 'B. He said "I will be there soon."', 'C. He said, "I will be there soon."', 'D. He said I will be there soon.', 'C'),
('Q102', 'Choose the sentence with the correct use of "its" or "its": The cat licked its paw.', 'A. The cat licked its paw.', 'B. Its time to go home.', 'C. The cat licked its paw.', 'D. Its a lovely day outside.', 'C'),
('Q103', 'Select the sentence with correct word order: He always has been very funny.', 'A. He always has been very funny.', 'B. He always has been funny very.', 'C. He has always been very funny.', 'D. He has always funny been very.', 'C'),
('Q104', 'Identify the sentence with the correct use of commas: She went to the store and bought milk bread and eggs.', 'A. She went to the store and bought milk bread and eggs.', 'B. She went to the store, and bought milk, bread, and eggs.', 'C. She went to the store, and bought milk bread, and eggs.', 'D. She went to the store, and bought, milk, bread, and eggs.', 'B'),
('Q105', 'Choose the sentence with the correct capitalization: my moms birthday is in may.', 'A. my moms birthday is in may.', 'B. My Moms Birthday is in May.', 'C. My moms Birthday is in may.', 'D. My moms birthday is in May.', 'D'),
('Q106', 'Identify the sentence with the correct spelling: Embarrassing', 'A. Embarrasing', 'B. Embarrassing', 'C. Embarassing', 'D. Embarasing', 'B'),
('Q107', 'Select the sentence with correct verb tense: They are going to the beach tomorrow.', 'A. They will going to the beach tomorrow.', 'B. They are going to the beach tomorrow.', 'C. They going to the beach tomorrow.', 'D. They went to the beach tomorrow.', 'B'),
('Q108', 'Choose the sentence with the correct use of your or youre: Youre coming to the party, right?', 'A. Your coming to the party, right?', 'B. Youre coming to the party, right?', 'C. Your going to love the party decorations.', 'D. Youre going to love the party decorations.', 'B'),
('Q109', 'Identify the sentence with the correct use of apostrophes: The cats toys are everywhere.', 'A. The cats toys are everywhere.', 'B. The cats toys are everywhere.', 'C. The cats toys are everywhere.', 'D. The catss toys are everywhere.', 'B'),
('Q110', 'Choose the sentence with the correct word order: Yesterday I went to the movies.', 'A. I yesterday went to the movies.', 'B. Yesterday I went to the movies.', 'C. Yesterday went I to the movies.', 'D. I went yesterday to the movies.', 'B'),
('Q111', 'Select the sentence with correct punctuation: Are you coming to the party?', 'A. Are you coming to the party', 'B. Are you coming to the party?', 'C. Are you coming, to the party?', 'D. Are you coming to the party.', 'B'),
('Q112', 'Identify the sentence with the correct spelling: Occasion', 'A. Occassion', 'B. Occassion', 'C. Occasion', 'D. Occassion', 'C'),
('Q113', 'Choose the sentence with the correct use of its or it is: Its raining outside.', 'A. Its raining outside.', 'B. Its raining outside.', 'C. Its raining outside.', 'D. Its raining outside.', 'B'),
('Q114', 'Select the sentence with correct verb tense: He had eaten lunch before he went to the meeting.', 'A. He had ate lunch before he went to the meeting.', 'B. He eats lunch before he went to the meeting.', 'C. He had eaten lunch before he went to the meeting.', 'D. He eaten lunch before he went to the meeting.', 'C'),
('Q115', 'Identify the sentence with the correct subject-verb agreement: The team is ready to play.', 'A. The team are ready to play.', 'B. The team is ready to play.', 'C. The team was ready to play.', 'D. The team were ready to play.', 'B'),
('Q116', 'Choose the sentence with the correct use of commas: I need to go to the store, and buy milk, eggs, and bread.', 'A. I need to go to the store and buy milk eggs and bread.', 'B. I need to go to the store, and buy milk, bread, and eggs.', 'C. I need to go, to the store and buy, milk eggs and bread.', 'D. I need, to go to the store and buy milk, eggs and bread.', 'B'),
('Q117', 'Select the sentence with correct word order: Yesterday went we to the zoo.', 'A. Yesterday went we to the zoo.', 'B. We went yesterday to the zoo.', 'C. Yesterday to the zoo went we.', 'D. Yesterday we went to the zoo.', 'D'),
('Q118', 'Choose the sentence with the correct use of whose or whos: Whos going to the party tonight?', 'A. Whos going to the party tonight?', 'B. Whose going to the party tonight?', 'C. Who is going to the party tonight?', 'D. Whose going to the party tonight?', 'A'),
('Q119', 'Identify the sentence with the correct use of apostrophes: The childrens toys were scattered across the room.', 'A. The childrens toys were scattered across the room.', 'B. The childrens toys were scattered across the room.', 'C. The childrens toys were scattered across the room.', 'D. The childrens toys were scattered across the room.', 'A'),
('Q120', 'Choose the sentence with the correct use of to too or two: She wants to go to the store with you.', 'A. She wants to go to the store with you.', 'B. She wants too go to the store with you.', 'C. She wants two go to the store with you.', 'D. She wants too go to the store with you.', 'A'),
('Q121', 'Select the sentence with correct verb tense: They will be arriving at the airport in an hour.', 'A. They will arriving at the airport in an hour.', 'B. They will be arriving at the airport in an hour.', 'C. They be arriving at the airport in an hour.', 'D. They will to be arriving at the airport in an hour.', 'B'),
('Q122', 'Identify the sentence with the correct spelling: Definitely', 'A. Definately', 'B. Definately', 'C. Definitely', 'D. Definetly', 'C'),
('Q123', 'Choose the sentence with the correct capitalization: i have a meeting at noon.', 'A. i have a meeting at noon.', 'B. I have a meeting at noon.', 'C. I Have a Meeting at Noon.', 'D. i have a meeting at noon.', 'B'),
('Q124', 'Select the sentence with the correct use of commas: After the game they went out to eat and then to a movie.', 'A. After the game they went out to eat and then to a movie.', 'B. After the game, they went out to eat and then, to a movie.', 'C. After the game, they went out to eat, and then to a movie.', 'D. After the game they went out to eat, and then to a movie.', 'C'),
('Q125', 'Identify the sentence with the correct use of their, there or theyre: Theyre going to meet their friends there.', 'A. Theyre going to meet there friends their.', 'B. Theyre going to meet their friends there.', 'C. Their going to meet there friends.', 'D. Theyre going to meet their friends theyre.', 'B'),
('Q126', 'Choose the sentence with the correct use of affect or effect: The loud noise affected my concentration.', 'A. The loud noise affected my concentration.', 'B. The loud noise effected my concentration.', 'C. The loud noise effect my concentration.', 'D. The loud noise affect my concentration.', 'A'),
('Q127', 'Select the sentence with correct verb tense: She had finished her homework before dinner.', 'A. She had finish her homework before dinner.', 'B. She has finished her homework before dinner.', 'C. She have finished her homework before dinner.', 'D. She had finishes her homework before dinner.', 'B')